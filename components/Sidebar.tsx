...
import { Home, Calendar, CreditCard, Landmark, TrendingUp, Car, Home as HomeIcon, Heart, Settings, X, ChevronRight, LogOut } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onNavigate, activeTab, userName, onLogout }) => {
  ...
  return (
    <>
      {/* Backdrop */}
      <div 
        className={`fixed inset-0 z-50 bg-[#13312A]/40 backdrop-blur-sm transition-opacity duration-300 ${
      ...
      {/* Sidebar Panel */}
      <div 
        className={`fixed top-0 left-0 bottom-0 z-50 w-72 bg-[#FFFDF5] shadow-2xl transform transition-transform duration-300 ease-out ${
        ...
        <div className="h-full flex flex-col overflow-y-auto no-scrollbar">
          ...
          <div className="p-6 pb-2">
            <div className="flex justify-between items-center mb-6">
               <h2 className="text-2xl font-bold text-[#13312A] font-serif">Menu</h2>
               <button onClick={onClose} className="p-2 bg-[#F6E9CA] rounded-full text-[#155446] hover:bg-[#C69A72]/20">
                 <X size={20} />
               </button>
            </div>
            
            <div className="bg-[#13312A] p-4 rounded-2xl text-white flex items-center gap-3 mb-4 shadow-lg shadow-[#13312A]/20">
               ...
               <div>
                  ...
                  <p className="font-bold truncate max-w-[140px] font-serif">{userName}</p>
               </div>
            </div>
          </div>
          ...
          {/* Footer */}
          <div className="p-6 border-t border-[#13312A]/5 bg-[#F6E9CA]/30">
             ...
             <p className="text-[10px] text-[#155446] mt-4">Finanças Blue v2.3 (Forest)</p>
          </div>
